...
internal static class Globalizations
{
    ...
    public static class SH
    {
        ...
        /// <summary>
        /// Gets the localized string for "Another instance is already running" message.
        /// </summary>
        public static string AnotherInstanceRunning => GetResources(nameof(AnotherInstanceRunning));
        ...
        private static string ReturnSimplifiedChinese(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "另一个 SecondaryClick 程序正在运行",
        ...
        private static string ReturnTraditionalChinese(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "另一個 SecondaryClick 程式正在執行",
        ...
        private static string ReturnJapanese(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "別の SecondaryClick が既に実行中です",
        ...
        private static string ReturnArabic(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "هناك نسخة أخرى من SecondaryClick قيد التشغيل بالفعل",
        ...
        private static string ReturnHungarian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "A SecondaryClick egy másik példánya már fut",
        ...
        private static string ReturnSlovak(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Ďalšia inštancia SecondaryClick už beží",
        ...
        private static string ReturnIndonesian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Instans SecondaryClick lain sudah berjalan",
        ...
        private static string ReturnKorean(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "다른 SecondaryClick 인스턴스가 이미 실행 중입니다",
        ...
        private static string ReturnCatalan(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Una altra instància de SecondaryClick ja s'està executant",
        ...
        private static string ReturnGerman(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Eine andere SecondaryClick-Instanz läuft bereits",
        ...
        private static string ReturnSpanish(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Otra instancia de SecondaryClick ya se está ejecutando",
        ...
        private static string ReturnFrench(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Une autre instance de SecondaryClick est déjà en cours d'exécution",
        ...
        private static string ReturnItalian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Un'altra istanza di SecondaryClick è già in esecuzione",
        ...
        private static string ReturnNorwegian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "En annen SecondaryClick-instans kjører allerede",
        ...
        private static string ReturnDutch(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Er draait al een andere SecondaryClick-instantie",
        ...
        private static string ReturnPolish(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Inna instancja SecondaryClick jest już uruchomiona",
        ...
        private static string ReturnPortugueseBrazil(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Outra instância do SecondaryClick já está em execução",
        ...
        private static string ReturnRussian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Другой экземпляр SecondaryClick уже запущен",
        ...
        private static string ReturnTurkish(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "SecondaryClick'in başka bir örneği zaten çalışıyor",
        ...
        private static string ReturnUkrainian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Інший екземпляр SecondaryClick уже запущено",
        ...
        private static string ReturnVietnamese(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Một phiên bản SecondaryClick khác đang chạy",
        ...
        private static string ReturnMarathi(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "SecondaryClick ची दुसरी प्रत आधीच चालू आहे",
        ...
        private static string ReturnHindi(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "SecondaryClick का एक और इंस्टेंस पहले से चल रहा है",
        ...
        private static string ReturnHebrew(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "מופע נוסף של SecondaryClick כבר פועל",
        ...
        private static string ReturnGreek(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "Μια άλλη παρουσία του SecondaryClick εκτελείται ήδη",
        ...
        private static string ReturnSwedish(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "En annan SecondaryClick-instans körs redan",
        ...
        private static string ReturnRomanian(string name) => name switch
        {
            ...
            nameof(AnotherInstanceRunning) => "O altă instanță SecondaryClick rulează deja",
